        ...
        <div className="main">
            ...
            <div className="tabs" style={tabs}>
                ...
                <div className="tab " style={{...tab}}
                 onClick={() => navigate('/dblayer2')}>Layer 2</div>
            </div>

            <div className="content" style ={content}>
                <h1 className="title" style={title}>Layer 1</h1>
                <p className="scan-count" style={scancount}>1000 files</p>
                <div className="buttons" style={buttons}>
                    <div className="button1"style={{...button,...button1}}>Learn more</div>
                    <div className="button2"style={{...button,...button2}}
                    onClick={()=>navigate('/l1_scan')}>Scan me</div>
